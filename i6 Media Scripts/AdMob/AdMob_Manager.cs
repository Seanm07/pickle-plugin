...
public class AdMob_Manager : MonoBehaviour {
    ...
    public void OpenAdInspector() {
        ...
        if (PlayerPrefs.GetInt("admob_test_mode", 0) == 0) {
            ...
            JarLoader.DisplayToastMessage("AdMob test mode enabled, restart app to use ad inspector");
        } else {
    ...
    private void DoOpenAdInspectorMainThread() {
        ...
        MobileAds.OpenAdInspector(error => {
            if (error != null) {
                ...
                JarLoader.DisplayToastMessage("Failed to open ad inspector - " + errorMsg);
            } else {
